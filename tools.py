...
class ToolsManager:
    ...
    def display_menu(self) -> None:
        ...
        # Track total index across both columns
        total_idx = 1
        ...
        while left_categories or right_categories:
            ...
            # Process left column if available
            if left_categories:
            ...
            # Process right column if available
            if right_categories:
    ...
    # [Rest of the ToolsManager class remains unchanged]
